// Mock data for loans
const loanAccounts = [
    { phoneNumber: '+1234567890', activeLoans: [{ id: 'L1', amount: 100.00 }], statements: ['Borrowed KSH 100.00', 'Repaid KSH 20.00'] },
        ...
        return new Promise((resolve) => {
            setTimeout(() => {
                ...
                if (account) {
                    ...
                    account.statements.push(`Borrowed KSH ${parseFloat(amount).toFixed(2)}`);
